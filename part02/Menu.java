...
public class Menu {
	...
	/**
	 * displays the meny title followed by the options for selection replaced
	 * incrementing int with a "-" as an incremented int does not match the required
	 * user input for the coins
	 */
	protected void coinDisplay() {
		if (title != null && options != null) {
			// title and options are valid
			// display title and underline with '+'
			System.out.println(title);
